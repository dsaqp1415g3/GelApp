...
import edu.upc.eetac.dsa.dsaqp1415g3.gelapp.api.VotosResource;
...
public class GelAppRootAPI {
	@InjectLinks({
		...
		@InjectLink(resource = VotosResource.class, style = Style.ABSOLUTE, rel = "vote", title = "vote", type=MediaType.GELAPP_API_VOTOS),
